...
```
implementation "com.1d3:checkout-sdk-android:1.13.2"
```
****
...
@Override
 protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
     ...
     if (requestCode == PAY_ACTIVITY_REQUEST) {
         ...
         if(data != null && data.hasExtra(ODTPaySDK.DATA_INTENT_SESSION_INTERRUPTED)) {
             String token = data.getStringExtra(ODTPaySDK.DATA_INTENT_SESSION_INTERRUPTED);
         }
     }
 }
```
